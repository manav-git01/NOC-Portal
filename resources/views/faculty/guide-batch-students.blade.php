    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            <div class="flex items-center space-x-4">
                <a href="{{ route('faculty.guide-dashboard') }}"
                   class="inline-flex items-center px-3 py-2 bg-white border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 hover:border-gray-400 transition shadow-sm">
                    <i class="fas fa-arrow-left mr-2 text-xs"></i>Back to Batches
                </a>
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 flex items-center">
                        <i class="fas fa-users text-indigo-600 mr-3"></i>{{ $batch->name }}
                    </h1>
                    <p class="text-sm text-gray-500 mt-0.5">Students assigned to you in this batch</p>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-10">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 border-t-[3px] border-t-orange-400 p-5 hover:shadow-md transition-shadow duration-200">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <h3 class="text-2xl font-bold text-gray-800 mt-0.5">{{ $batchApplications }}</h3>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 border-t-[3px] border-t-rose-400 p-5 hover:shadow-md transition-shadow duration-200">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <p class="text-rose-600 text-xs font-bold uppercase tracking-wider">Pending</p>
                        <h3 class="text-2xl font-bold text-gray-800 mt-0.5">{{ $batchPending }}</h3>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 border-t-[3px] border-t-green-400 p-5 hover:shadow-md transition-shadow duration-200">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <h3 class="text-2xl font-bold text-gray-800 mt-0.5">{{ $batchApproved }}</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 mb-6">
            <form method="GET" action="{{ route('faculty.guide.batch-students', $batch) }}" class="flex flex-col md:flex-row md:items-end gap-4" id="filterForm">
                <!-- Search Input -->
                <div class="flex-1">
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <a href="{{ route('faculty.guide.batch-students', $batch) }}" class="inline-flex items-center px-4 py-2.5 bg-gray-100 text-gray-700 rounded-lg text-sm font-semibold hover:bg-gray-200 transition">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
            <div class="bg-indigo-600 px-6 py-4 flex items-center justify-between">
                <h3 class="text-lg font-bold text-white flex items-center">
                    <i class="fas fa-id-card-alt mr-3"></i>Student Directory — {{ $batch->name }}
                </h3>
            ...
            @if($students->isEmpty())
                <div class="text-center py-16">
                    ...
                    @if(request()->hasAny(['search', 'status', 'noc_status']))
                        <a href="{{ route('faculty.guide.batch-students', $batch) }}" class="inline-flex items-center mt-3 text-indigo-600 hover:text-indigo-800 text-sm font-semibold">
